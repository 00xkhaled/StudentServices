...
@Named(value = "busInformationBean")
@SessionScoped
public class BusInformationBean implements Serializable {
    ...
    private BusInformation selectedBus;//model object to save selected student;
    private final BusInformationDao bus=new BusInformationDao();//dao object;
    private ArrayList<BusInformation> list;//list of type model to save result from database
